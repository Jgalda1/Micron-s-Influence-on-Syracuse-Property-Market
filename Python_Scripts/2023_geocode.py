...
wgs84 = 4326
read = pd.read_csv("Real_Estate_Transactions_2023")
#
...
#add merge address, municiplaity, and state
#this is to keep the same format 
print(addresses)
...
adds.to_csv('lat_long2023.csv',index=False)
